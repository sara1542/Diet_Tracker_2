      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <
            ...
            if (widget.isPressed)
              getmeal(" Breakfast $bfCalories calories", Breakfast,
            ...
            if (widget.isPressed)
              getmeal(" Lunch $lCalories calories", Lunch,
            ...
            if (widget.isPressed)
              getmeal("Dinner $dCalories calories", Dinner,
            ...
            if (widget.isPressed)
              getmeal("First Snack $s1Calories calories", First_Snack,
            ...
            if (widget.isPressed)
              getmeal("Second Snack: $s2Calories calories", Second_Snack,
                  const Icon(Icons.food_bank_outlined), context),
            if (widget.isPressed)
              ElevatedButton(
                style: ElevatedButton.styleFrom(
